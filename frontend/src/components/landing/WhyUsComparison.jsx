          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
            <thead>
              <tr style={{ background: 'rgba(99, 102, 241, 0.1)', borderBottom: '1px solid var(--color-border-subtle)' }}>
                <th style={{ padding: '16px 24px', fontSize: '0.9rem', color: 'var(--color-text-primary)' }}>Feature / Capability</th>
                <th style={{ padding: '16px 24px', fontSize: '0.95rem', color: 'var(--color-accent-primary)', fontWeight: '700', textTransform: 'uppercase' }}>PMS Engine v2</th>
                <th style={{ padding: '16px 24px', fontSize: '0.9rem', color: 'var(--color-text-muted)' }}>TradingView</th>
                <th style={{ padding: '16px 24px', fontSize: '0.9rem', color: 'var(--color-text-muted)' }}>Screener.in</th>
              </tr>
            </thead>
            <tbody>
              {comparisonData.map((row, idx) => (
                <tr key={idx} style={{ borderBottom: '1px solid var(--color-border-subtle)' }}>
                  ...
                  <td style={{ padding: '16px 24px', background: 'rgba(99, 102, 241, 0.04)' }}>
